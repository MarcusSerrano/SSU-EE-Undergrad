...
HD_PWD='C:/Users/Marcus Serrano/Documents/Vivado/project_frequencycounter/project_frequencycounter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log eqprec_min_io.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source eqprec_min_io.tcl -notrace
