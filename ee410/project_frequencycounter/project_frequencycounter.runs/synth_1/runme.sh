...
HD_PWD='C:/Users/Marcus Serrano/Documents/Vivado/project_frequencycounter/project_frequencycounter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log eqprec_min_io.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source eqprec_min_io.tcl
