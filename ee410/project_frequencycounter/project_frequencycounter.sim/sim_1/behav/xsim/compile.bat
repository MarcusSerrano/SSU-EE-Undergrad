...
REM
REM Generated by Vivado on Wed Oct 15 22:41:13 -0700 2025
...
echo "xvlog --incr --relax -prj tb_min_vlog.prj"
call xvlog  --incr --relax -prj tb_min_vlog.prj -log xvlog.log
