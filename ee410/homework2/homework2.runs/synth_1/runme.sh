...
HD_PWD='C:/Users/Marcus Serrano/Documents/Vivado/homework2/homework2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log homework2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source homework2.tcl
