...
REM
REM Generated by Vivado on Sat Nov 01 16:39:24 -0700 2025
...
echo "xvlog --incr --relax -prj tb_timing_controller_vlog.prj"
call xvlog  --incr --relax -prj tb_timing_controller_vlog.prj -log xvlog.log
