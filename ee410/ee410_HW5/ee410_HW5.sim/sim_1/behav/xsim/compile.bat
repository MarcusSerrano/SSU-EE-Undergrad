...
REM
REM Generated by Vivado on Thu Nov 20 22:14:08 -0800 2025
...
echo "xvlog --incr --relax -prj tb_101_sequence_detectors_vlog.prj"
call xvlog  --incr --relax -prj tb_101_sequence_detectors_vlog.prj -log xvlog.log
