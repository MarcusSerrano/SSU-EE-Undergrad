...
#
# Script generated by Vivado on Sat Nov 22 23:22:27 -0800 2025
# SW Build 6140274 on Thu May 22 00:12:29 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : pll_clk_gen.sh
...
#
# Usage        : pll_clk_gen.sh
#                pll_clk_gen.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                pll_clk_gen.sh [-reset_run]
#                pll_clk_gen.sh [-reset_log]
#                pll_clk_gen.sh [-help]
#
...
# script info
echo -e "pll_clk_gen.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./pll_clk_gen.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot pll_clk_gen xil_defaultlib.pll_clk_gen xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim pll_clk_gen -key {Behavioral:sim_1:Functional:pll_clk_gen} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb pll_clk_gen.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./pll_clk_gen.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: pll_clk_gen.sh [-help]\n\
Usage: pll_clk_gen.sh [-step]\n\
Usage: pll_clk_gen.sh [-lib_map_path]\n\
Usage: pll_clk_gen.sh [-reset_run]\n\
Usage: pll_clk_gen.sh [-reset_log]\n\
Usage: pll_clk_gen.sh [-keep_index]\n\
Usage: pll_clk_gen.sh [-noclean_files]\n\n\
