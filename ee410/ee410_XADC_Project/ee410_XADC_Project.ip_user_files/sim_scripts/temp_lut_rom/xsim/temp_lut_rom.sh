...
#
# Script generated by Vivado on Sat Nov 22 22:18:01 -0800 2025
# SW Build 6140274 on Thu May 22 00:12:29 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : temp_lut_rom.sh
...
#
# Usage        : temp_lut_rom.sh
#                temp_lut_rom.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                temp_lut_rom.sh [-reset_run]
#                temp_lut_rom.sh [-reset_log]
#                temp_lut_rom.sh [-help]
#
...
# script info
echo -e "temp_lut_rom.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./temp_lut_rom.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_11 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot temp_lut_rom xil_defaultlib.temp_lut_rom xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim temp_lut_rom -key {Behavioral:sim_1:Functional:temp_lut_rom} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb temp_lut_rom.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./temp_lut_rom.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: temp_lut_rom.sh [-help]\n\
Usage: temp_lut_rom.sh [-step]\n\
Usage: temp_lut_rom.sh [-lib_map_path]\n\
Usage: temp_lut_rom.sh [-reset_run]\n\
Usage: temp_lut_rom.sh [-reset_log]\n\
Usage: temp_lut_rom.sh [-keep_index]\n\
Usage: temp_lut_rom.sh [-noclean_files]\n\n\
