...
HD_PWD='C:/Users/Marcus/Documents/Vivado/ee410_XADC_Project/ee410_XADC_Project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_xadc_temp.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_xadc_temp.tcl
