...
HD_PWD='C:/Users/Marcus/Documents/Vivado/ee410_XADC_Project/ee410_XADC_Project.runs/pll_clk_gen_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pll_clk_gen.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pll_clk_gen.tcl
