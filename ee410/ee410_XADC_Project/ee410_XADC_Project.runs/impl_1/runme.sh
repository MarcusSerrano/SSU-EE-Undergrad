...
HD_PWD='C:/Users/Marcus/Documents/Vivado/ee410_XADC_Project/ee410_XADC_Project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_xadc_temp.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_xadc_temp.tcl -notrace
