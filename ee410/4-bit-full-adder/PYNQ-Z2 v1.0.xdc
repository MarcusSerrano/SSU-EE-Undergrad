...
set_property -dict { PACKAGE_PIN N15   IOSTANDARD LVCMOS33 } [get_ports { cout }]; #IO_L21P_T3_DQS_AD14P_35 Sch=led4_r
...
set_property -dict { PACKAGE_PIN M14   IOSTANDARD LVCMOS33 } [get_ports { s3 }]; #IO_L23P_T3_35 Sch=led[3]
...
set_property -dict { PACKAGE_PIN Y18   IOSTANDARD LVCMOS33 } [get_ports { b2 }]; #IO_L17P_T2_34 Sch=rpio_04_r
set_property -dict { PACKAGE_PIN Y19   IOSTANDARD LVCMOS33 } [get_ports { a0 }]; #IO_L17N_T2_34 Sch=rpio_05_r
set_property -dict { PACKAGE_PIN U18   IOSTANDARD LVCMOS33 } [get_ports { a1 }]; #IO_L22P_T3_13 Sch=rpio_06_r
...
set_property -dict { PACKAGE_PIN W8    IOSTANDARD LVCMOS33 } [get_ports { a2 }]; #IO_L15N_T2_DQS_13 Sch=rpio_13_r
set_property -dict { PACKAGE_PIN V6    IOSTANDARD LVCMOS33 } [get_ports { b0 }]; #IO_L22P_T3_13 Sch=rpio_14_r
set_property -dict { PACKAGE_PIN Y6    IOSTANDARD LVCMOS33 } [get_ports { b1 }]; #IO_L13N_T2_MRCC_13 Sch=rpio_15_r
#set_property -dict { PACKAGE_PIN B19   IOSTANDARD LVCMOS33 } [get_ports { rpio_16_r }]; #IO_L2P_T0_AD8P_35 Sch=rpio_16_r
set_property -dict { PACKAGE_PIN U7    IOSTANDARD LVCMOS33 } [get_ports { b3 }]; #IO_L11P_T1_SRCC_13 Sch=rpio_17_r
#set_property -dict { PACKAGE_PIN C20   IOSTANDARD LVCMOS33 } [get_ports { rpio_18_r }]; #IO_L1P_T0_AD0P_35 Sch=rpio_18_r
set_property -dict { PACKAGE_PIN Y8    IOSTANDARD LVCMOS33 } [get_ports { a3 }]; #IO_L14N_T2_SRCC_13 Sch=rpio_19_r
...
set_property -dict { PACKAGE_PIN W9    IOSTANDARD LVCMOS33 } [get_ports { cin }]; #IO_L16N_T2_13 Sch=rpio_26_r
...
## Internal pulldown resistors for inputs:
# cin -> W9
set_property -dict { PACKAGE_PIN W9  IOSTANDARD LVCMOS33 PULLDOWN true } [get_ports { cin }];

# a3 -> Y8
set_property -dict { PACKAGE_PIN Y8  IOSTANDARD LVCMOS33 PULLDOWN true } [get_ports { a3 }];   

# a2 -> W8
set_property -dict { PACKAGE_PIN W8  IOSTANDARD LVCMOS33 PULLDOWN true } [get_ports { a2 }];   

# a1 -> U18
set_property -dict { PACKAGE_PIN U18 IOSTANDARD LVCMOS33 PULLDOWN true } [get_ports { a1 }];   

# a0 -> Y19
set_property -dict { PACKAGE_PIN Y19 IOSTANDARD LVCMOS33 PULLDOWN true } [get_ports { a0 }];   

# b3 -> U7
set_property -dict { PACKAGE_PIN U7  IOSTANDARD LVCMOS33 PULLDOWN true } [get_ports { b3 }];   

# b2 -> Y18
set_property -dict { PACKAGE_PIN Y18 IOSTANDARD LVCMOS33 PULLDOWN true } [get_ports { b2 }];   

# b1 -> Y6
set_property -dict { PACKAGE_PIN Y6 IOSTANDARD LVCMOS33 PULLDOWN true } [get_ports { b1 }];   

# b0 -> V6
set_property -dict { PACKAGE_PIN V6 IOSTANDARD LVCMOS33 PULLDOWN true } [get_ports { b0 }];   