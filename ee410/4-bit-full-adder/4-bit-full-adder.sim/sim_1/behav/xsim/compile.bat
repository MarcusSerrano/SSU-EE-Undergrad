...
REM
REM Generated by Vivado on Sat Nov 01 15:09:25 -0700 2025
...
echo "xvlog --incr --relax -prj tb_adder_register_vlog.prj"
call xvlog  --incr --relax -prj tb_adder_register_vlog.prj -log xvlog.log
